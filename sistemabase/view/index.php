        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center aling-items-center h-100">
                ...
                <div class ="col-md-9 col-lg-6 col-xl-5">
                    <img src="assets/img/logos/Logo_personal-removebg-preview.png" class="img-fluid">
                </div>
                <div class ="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <form class ="form" method ="POST" action ="../controller/login/loginController.php">
                        ...
                        <!-- INPUT USUARIO-->
                        <div class ="form-outline mb4">
                        <label class ="form-label" for ="inUsuario">Password:</label>
                            <input type="password" class ="form-control form-control-lg" placeholder ="Ingrese su contraseña" id ="inPassword" name ="inPassword"/>    
                        </div>
